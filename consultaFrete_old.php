...
if (getval('btnSubmit', false)){
	...
	$nCdServicoOpcoes = array(	"41068" => array("nome" => "PAC", "image" => "pac.gif"),
								"40096" => array("nome" => "Sedex", "image" => "sedex.gif"),
								"40215" => array("nome" => "Sedex10", "image" => "sedex10.gif"),
								"81019" => array("nome" => "eSedex", "image" => "esedex.gif")
								);
	...
	// Recuperando no índice 7 (cidade/uf) os valores
	$spanEndereco = explode ("/", $dom->getElementsByTagName('span')->item(7)->nodeValue);
